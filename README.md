...
```bash
git clone https://github.com/Hyelow0/RL-Total-Dominating-main.git
cd RL-Tatal-Dominating-main
pip install -r requirements.txt
```

## Contributing
Contributions to RL-Total-Dominating are welcome! If you have suggestions for improvements or want to report a bug, please open an issue or submit a pull request.
